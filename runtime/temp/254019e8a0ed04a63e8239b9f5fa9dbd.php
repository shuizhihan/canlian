<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\wamp64\www\canlian\public/../application/admin\view\ad\edit.htm";i:1523155210;s:70:"D:\wamp64\www\canlian\public/../application/admin\view\common\head.htm";i:1500202164;s:70:"D:\wamp64\www\canlian\public/../application/admin\view\common\left.htm";i:1523088054;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>新誉佳高级中学</title>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                        ...
                        <?php if($adflashRes): if(is_array($adflashRes) || $adflashRes instanceof \think\Collection || $adflashRes instanceof \think\Paginator): $i = 0; $__LIST__ = $adflashRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$adflash): $mod = ($i % 2 );++$i;?>
                                <div class="form-group">
                                    <label for="username" class="col-sm-2 control-label no-padding-right"><a href="javascript:;" id="<?php echo $adflash['id']; ?>" onclick="dt(this);"><?php if($i == 1): ?>[+]<?php else: ?>[-]<?php endif; ?></a></label>
